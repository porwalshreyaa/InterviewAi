...
function buildInterviewReviewPrompt({ role, candidateSummary, qaPairs }) {
  ...
  return `You are a senior technical interviewer. Review this completed mock interview.
...
export async function streamInterviewReview({ role, candidateSummary, qaPairs, onChunk }) {
  const prompt = buildInterviewReviewPrompt({ role, candidateSummary, qaPairs });
